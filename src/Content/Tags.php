...
class Tags
{
    ...
    public function __invoke(Document $document, Request $request)
    {
        ...
        $document->title = $this->translator->trans('duroom-tags.forum.all_tags.meta_title_text');
        $document->meta['description'] = $this->translator->trans('duroom-tags.forum.all_tags.meta_description_text');
