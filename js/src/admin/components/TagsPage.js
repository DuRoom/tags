...
export default class TagsPage extends ExtensionPage {
  ...
  content() {
    ...
    const minPrimaryTags = this.setting('duroom-tags.min_primary_tags', 0);
    const maxPrimaryTags = this.setting('duroom-tags.max_primary_tags', 0);

    const minSecondaryTags = this.setting('duroom-tags.min_secondary_tags', 0);
    const maxSecondaryTags = this.setting('duroom-tags.max_secondary_tags', 0);
        ...
        <div className="TagsContent-list">
          <div className="container" key={this.forcedRefreshKey} oncreate={this.onListOnCreate.bind(this)}><div className="SettingsGroups">
            <div className="TagGroup">
              <label>{app.translator.trans('duroom-tags.admin.tags.primary_heading')}</label>
              ...
              {Button.component(
                ...
                app.translator.trans('duroom-tags.admin.tags.create_primary_tag_button')
              )}
            </div>

            <div className="TagGroup TagGroup--secondary">
              <label>{app.translator.trans('duroom-tags.admin.tags.secondary_heading')}</label>
              ...
              {Button.component(
                ...
                app.translator.trans('duroom-tags.admin.tags.create_secondary_tag_button')
              )}
            </div>
            <div className="Form">
              <label>{app.translator.trans('duroom-tags.admin.tags.settings_heading')}</label>
              <div className="Form-group">
                <label>{app.translator.trans('duroom-tags.admin.tag_settings.required_primary_heading')}</label>
                <div className="helpText">{app.translator.trans('duroom-tags.admin.tag_settings.required_primary_text')}</div>
                <div className="TagSettings-rangeInput">
                  ...
                  />
                  {app.translator.trans('duroom-tags.admin.tag_settings.range_separator_text')}
                  <input className="FormControl" type="number" min={minPrimaryTags()} bidi={maxPrimaryTags} />
                </div>
              </div>
              <div className="Form-group">
                <label>{app.translator.trans('duroom-tags.admin.tag_settings.required_secondary_heading')}</label>
                <div className="helpText">{app.translator.trans('duroom-tags.admin.tag_settings.required_secondary_text')}</div>
                <div className="TagSettings-rangeInput">
                  <input
                    className="FormControl"
                    type="number"
            ...
            <div className="TagsContent-footer">
              <p>{app.translator.trans('duroom-tags.admin.tags.about_tags_text')}</p>
            </div>
          </div>
        </div>
      </div>
