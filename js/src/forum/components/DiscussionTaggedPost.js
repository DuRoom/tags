import EventPost from 'duroom/components/EventPost';
...
export default class DiscussionTaggedPost extends EventPost {
  ...
  descriptionKey() {
    if (this.attrs.tagsAdded.length) {
      if (this.attrs.tagsRemoved.length) {
        return 'duroom-tags.forum.post_stream.added_and_removed_tags_text';
      }

      return 'duroom-tags.forum.post_stream.added_tags_text';
    }

    return 'duroom-tags.forum.post_stream.removed_tags_text';
  }
  ...
  descriptionData() {
    ...
    if (this.attrs.tagsAdded.length) {
      data.tagsAdded = app.translator.trans('duroom-tags.forum.post_stream.tags_text', {
    ...
    if (this.attrs.tagsRemoved.length) {
      data.tagsRemoved = app.translator.trans('duroom-tags.forum.post_stream.tags_text', {
