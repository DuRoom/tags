...
export default class TagsPage extends Page {
  oninit(vnode) {
    ...
    app.history.push('tags', app.translator.trans('duroom-tags.forum.header.back_to_tags_tooltip'));
  ...
  oncreate(vnode) {
    ...
    app.setTitle(app.translator.trans('duroom-tags.forum.all_tags.meta_title_text'));
    app.setTitleCount(0);
  }
}
